...
 * 描述 : “菜单新增”DTO
 * 创建人 : yn
 * 创建时间 : 2024年6月16日 上午8:41:44
 * 版本 : 1.0
 * 包名 : com.ccit.area.sales.dao.dto.system
 * 类名 : SystemMenuAddDTO
 */
@Data
@Schema(description = "【菜单新增】接受参数实体类")
public class SystemMenuAddDTO {
	 ...
	 * 子节点权限
	 */
	@Schema(description = "子节点权限,调用“根据字典编码获取子节点数组”接口【字典编码:purview】,传字典ID")
	private List<Long> childNodePowers;
