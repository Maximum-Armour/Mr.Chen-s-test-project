...
 * 描述 : “产品定价新增”DTO
 * 创建人 : yn
 * 创建时间 : 2024年8月14日 上午9:46:57
 * 版本 : 1.0
 * 包名 : com.ccit.area.sales.dao.dto.marketing
 * 类名 : ProductPriceAddDTO
 */
@Data
@Schema(description = "【产品定价新增】接受参数实体类")
public class ProductPriceAddDTO {
	 ...
	 * 产品定价明细数组
	 */
	@NotNull(message = "请新增产品定价明细！")
	@Schema(description = "产品定价明细数组")
	private List<ProductPriceItemAddDTO> itemAddList;
