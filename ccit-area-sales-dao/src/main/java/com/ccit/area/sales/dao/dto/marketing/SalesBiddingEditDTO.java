 ...
 *
  * 描述 : “产品竞价修改”DTO
  * 创建人 : tb
  * 创建时间 : 2024年9月9日 下午1:42:13
  * 版本 : 1.0
  * 包名 : com.ccit.area.sales.dao.dto.bidding
  * 类名 : SalesBiddingEditDTO
 */
@Data
@Schema(description = "【产品竞价修改】接受参数实体类")
public class SalesBiddingEditDTO {
     ...
     * 区域名称
     */
    @Length(max = 100, message = "区域编码长度不能超过100个字符")
