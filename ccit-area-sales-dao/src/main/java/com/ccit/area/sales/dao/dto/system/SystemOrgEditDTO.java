...
 * 描述 : “组织修改”DTO
 * 创建人 : yn
 * 创建时间 : 2024年7月9日 下午2:50:36
 * 版本 : 1.0
 * 包名 : com.ccit.area.sales.dao.dto.system
 * 类名 : SystemOrgEditDTO
 */
@Data
@Schema(description = "【组织修改】接受参数实体类")
public class SystemOrgEditDTO {
	...
	@Schema(description = "钉钉部门", requiredMode = RequiredMode.REQUIRED)
	private String dingdingDeptId;

	/**
	 * 钉钉部门名称
	 */
	@Length(max = 100, message = "钉钉部门名称长度不能超过50个字符")
